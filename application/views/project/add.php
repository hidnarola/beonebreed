                                ...
                                <form class="form" style="margin-bottom: 0;" method="post" action="" accept-charset="UTF-8">
                                    <div style="display:inline-block;float:left;width:45%" class='box-content'>
                                            ...
                                            <select class="form-control" name="category_id">
                                                ...
                                                if (!empty($categories)) {
                                                    foreach ($categories as $k => $v) {
                                                        ?>
                                                    <option value="<?php echo $v->id; ?>" <?php echo set_select( 'category_id', $v->id); ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="comment" name="quick_notes">
                                                <?php echo set_value('quick_notes'); ?>
                                            </textarea>
                                        </div>
                                    </div>
                                    <div style="display:inline-block;float:right;width:50%" class='box-content'>
                                            ...
                                            <select class="form-control" name="project_type_id" id="project_type_id">
                                                ...
                                                if (!empty($project_type)) {
                                                    foreach ($project_type as $k => $v) {
                                                        ?>
                                                    <option value="<?php echo $v->id; ?>" <?php echo set_select( 'project_type_id', $v->id); ?>>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class='estdate input-group' id='datepicker'>
                                                <input id="estimated_days" class='form-control ' name='estimated_days' data-format='yyyy-MM-dd' placeholder='Select datepicker' type='text' readonly="" value="<?php echo set_value('estimated_days'); ?>">
                                                ...
                                                <?php
                                                                        if (!empty($project_manager)) {
                                                                            foreach ($project_manager as $k => $v) {
                                                                                ?>
                                                    <option value="<?php echo $v->id; ?>" <?php echo set_select( 'project_manager', $v->username); ?>>
                                                        <?php echo ucfirst($v->username); ?>
                                                    </option>
                                                    <?php
                                                                            }
                                                                        }
