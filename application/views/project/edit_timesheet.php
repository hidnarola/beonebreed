        ...
        <div class='col-sm-12'>
            <div class='page-header'>
                ...
                <ul class='breadcrumb' style="padding-top: 62px;">
                    ...
                    <li>
                        <a href='<?php echo site_url('project/edit/' . $timesheet_list['project_id']); ?>'>Edit Project</a>
                    </li>
                    <li class='separator'>
                        <i class='icon-angle-right'></i>
                    </li>
                        ...
                        <div class='step-content'>
                            ...
                            <div style="display:inline-block;float:left;width:45%" class='box-content'>
                                <div class='form-group'>
                                    ...
                                    <input class='form-control' id='inputText' placeholder='Username' type='text' name='username' value="<?php if (!empty($timesheet_list['username'])) {
    echo $timesheet_list['username'];
} ?>">
                                    <span style="color:red"><?php echo form_error('username'); ?><span>
                                            </div>
                                            <div class='form-group'>
                                                <label for='inputText'>Total Time</label>
                                                <input class='form-control' id='inputText' placeholder='Total time' type='text' name='total_time' value="<?php if (!empty($timesheet_list['total_time'])) {
    echo $timesheet_list['total_time'];
} ?>">
                                                            ...
                                                            <span style="color:red"><?php echo form_error('dates'); ?><span>
                                                                    ...
                                                                    <div style="display:inline-block;float:right;width:50%" class='box-content'>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="5" id="comment" name="today_introduction"><?php if (!empty($timesheet_list['today_introduction'])) {
    echo $timesheet_list['today_introduction'];
} ?></textarea>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="comment">Research report of what has be done today</label>
                                                                            <textarea class="form-control" rows="5" id="comment" name="today_research_report"><?php if (!empty($timesheet_list['today_research_report'])) {
    echo $timesheet_list['today_research_report'];
} ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class='step-content'>
                                                                        ...
                                                                        <div style="display:inline-block;float:left;width:45%" class='box-content'>
                                                                            <div class='form-group'>
                                                                                <label for='inputText'>Username</label><span style="color:red">*</span>
                                                                                <input class='form-control' id='inputText' placeholder='Username' type='text' name='speciality_username' value="<?php if (!empty($timesheet_list['speciality_username'])) {
    echo $timesheet_list['speciality_username'];
} ?>">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <span style="color:red"><?php echo form_error('speciality_date'); ?><span>
                                                                                        ...
                                                                                        <div class='form-group'>
                                                                                            ...
                                                                                            <input class='form-control' id='inputText' placeholder='Speciality' type='text' name='speciality' value="<?php if (!empty($timesheet_list['speciality'])) {
    echo $timesheet_list['speciality'];
} ?>">
                                                                                        </div>
                                                                                        <div class='form-group'>
                                                                                            <label for='inputText'>Company Name</label>
                                                                                            <input class='form-control' id='inputText' placeholder='Company Name' type='text' name='company_name' value="<?php if (!empty($timesheet_list['company_name'])) {
    echo $timesheet_list['company_name'];
} ?>">
                                                                                        ...
                                                                                        <div style="display:inline-block;float:right;width:50%" class='box-content'>
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <textarea class="form-control" rows="5" id="comment" name="contact_info"><?php if (!empty($timesheet_list['Contact_info'])) {
    echo $timesheet_list['Contact_info'];
} ?></textarea>
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <label for="comment">Subject Discussion</label>
                                                                                                <textarea class="form-control" rows="5" id="comment" name="Subject_discussion"><?php if (!empty($timesheet_list['subject_discussion'])) {
    echo $timesheet_list['subject_discussion'];
} ?></textarea>
                                                                                            </div>
