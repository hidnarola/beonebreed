...
if (!empty($data_admin_part_1['marketing_complete'])) {
    ...
    if ($marketing_complete_part['part_1'] != '0') {
        $m_part1_class = 'active';
        $m_part1_check = 'checked="checked"';
    }
    if ($marketing_complete_part['part_2'] != '0') {
        $m_part2_class = 'active';
        $m_part2_check = 'checked="checked"';
    }
    if ($marketing_complete_part['part_3'] != '0') {
        $m_part3_class = 'active';
        $m_part3_check = 'checked="checked"';
    }
    if ($marketing_complete_part['part_4'] != '0') {
        $m_part4_class = 'active';
        $m_part4_check = 'checked="checked"';
    }
    if ($marketing_complete_part['part_5'] != '0') {
        $m_part5_class = 'active';
        $m_part5_check = 'checked="checked"';
    }
}
?>
    ...
    <div class="col-sm-12">
        <div class="box-main-scroll">
            ...
            <form class="form" style="margin-bottom: 0;" method="post" action="#" accept-charset="UTF-8" id="marketting_part_3">
                ...
                <input type="hidden" name="update_marketting" id="update_marketting" value="<?php
                if (!empty($m_part3_d)) {
                    echo 'update';
                }
                ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        foreach ($question_list_3 as $u_key) {
                            ...
                            $m_part3_data = $this->products_model->getfrom('product_question', false, array('where' => array('product_id' => $product_id, 'question_id' => $u_key->id)), array('single' => true)
                            );
                            ?>	
                            <div class="row check-list">
                                ...
                                <div class="col-sm-4">
                                    <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                                        ...
                                        <?php
                                        if (!empty($m_part3_data)) {
                                            if ($m_part3_data['answer'] == '1') {
...
<?php $m_part4_d = $this->products_model->getfrom('product_question', false, array('where' => array('question_id' => '7', 'product_id' => $product_id))); ?> 
                <input type="hidden" name="update_marketting_part_4" id="update_marketting_part_4" value="<?php
if (!empty($m_part4_d)) {
    echo 'update';
}
?>">
...
foreach ($question_list_4 as $u_key) {
    ...
    $m_part4_data = $this->products_model->getfrom('product_question', false, array('where' => array('product_id' => $product_id, 'question_id' => $u_key->id)), array('single' => true)
    );
    ?>	
                            <div class="row check-list">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-4">
                                    <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                                        ...
                                        <input type='checkbox' name='check_list[<?php echo $u_key->id; ?>]' 
                            <?php
                            if (!empty($m_part4_data)) {
                                if ($m_part4_data['answer'] == '1') {
                                    echo 'checked="checked"';
                                }
                            }
                            ?> >
                            ...
                            <div class='make-switch  pull-right switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                                <input type='checkbox' name="marketing_part5_switch1" id="marketing_part5_switch1" 
                                       ...
                                       if (!empty($marketing_part5_data)) {
                                           if ($marketing_part5_data['display_used'] == '1') {
                                               echo 'checked="checked"';
                                           }
                                       }
                                       ?> >
                        ...
                        <div class="part-five-block">
                            ...
                            <div class='make-switch pull-right switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                                <input type='checkbox' name="marketing_part5_switch2" id="marketing_part5_switch2" value="plv_used"
                                       <?php
                                       if (!empty($marketing_part5_data)) {
                                           if ($marketing_part5_data['plv_store_used'] == '1') {
                                               echo 'checked="checked"';
                                           }
                                       }
                                       ?>>
...
//                        $('#chkbox_marketing_part1').prop('checked', true); // Disable Checkbox
...
//                        $('#chkbox_marketing_part2').attr('checked', true); // Disable Checkbox
                        if (data.completed == 'true')
                        {
