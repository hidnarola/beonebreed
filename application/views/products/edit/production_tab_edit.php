<?php
   ...
   if(!empty($data_admin_part_1['production_complete'])){
        ...
        if($production_complete_part['part_1'] != '0') { $p_part1_class = 'active'; $p_part1_check = 'checked="checked" disabled="disabled"'; }
        if($production_complete_part['part_2'] != '0') { $p_part2_class = 'active'; $p_part2_check = 'checked="checked" disabled="disabled"'; }
        if($production_complete_part['part_3'] != '0') { $p_part3_class = 'active'; $p_part3_check = 'checked="checked" disabled="disabled"'; }
        if($production_complete_part['part_4'] != '0') { $p_part4_class = 'active'; $p_part4_check = 'checked="checked" disabled="disabled"'; }
        if($production_complete_part['part_5'] != '0') { $p_part5_class = 'active'; $p_part5_check = 'checked="checked" disabled="disabled"'; }
   }
            ...
            <?php 
                ...
                <div class="row prod_row_<?php echo $i; ?>">
                    ...
                    <div class="col-sm-6"><div class="form-group">
                          ...
                          <div class="controls">
                            <select name="supplier_<?php echo $i; ?>" id="supplier_<?php echo $i; ?>" class="form-control" onchange="$('.error_supplier_name_1').html('');fetch_supplier_data(this)" >
                                <option value="" selected readonly>Select Supplier</option>
                            <?php 
                                if(!empty($suppliers)) { 
                                    foreach($suppliers as $supplier) {
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group pull-right">
                          <div class="controls">
                            <input type="hidden" name="production_part_1_count" id="production_part_1_count" value="<?php if(empty($data_production_part_1)) { echo '1'; }else{ echo count($data_production_part_1); } ?>">
                                    ...
                                    <div class="controls">
                                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' 
                                             data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                                              ...
                                              <?php if($data_production_part_2[$i-1]['is_approve']=='1'){ echo 'checked="checked"'; } ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group pull-right">
                          <div class="controls">
                            <input type="hidden" name="production_part_2_count" id="production_part_2_count" 
                                   value="<?php if(empty($data_production_part_2)) { echo '1'; }else{ echo count($data_production_part_2); } ?>">
                ...
                <div class="label_main">   
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            ...
                            <?php if(!empty($ques_17)){ if($ques_17['answer']=='1'){ echo 'checked="checked"'; } } ?> value="17">
                        </div>
                   </div>
                </div>
                ...
                <div class="details_main">
                    ...
                    <div class="col-sm-5">
                       <textarea name="production_part3_notes1" id="production_part3_notes1" cols="30" rows="5" class="form-control" 
                                 onkeyup="$('.error_production_part3_notes1').addClass('hide');"><?php if(!empty($ques_17)){ echo $ques_17['notes']; } ?></textarea> 
                ...
                <div class="label_main">   
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            ...
                            <?php if(!empty($ques_18)){ if($ques_18['answer']=='1'){ echo 'checked="checked"'; } } ?> value="18">
                        </div>
                    </div>
                </div>
                ...
                <div class="label_main">   
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            ...
                            <?php if(!empty($ques_19)){ if($ques_19['answer']=='1'){ echo 'checked="checked"'; } } ?> value="19">
                        </div>
                   </div>
                </div>
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            <input type='checkbox' name="production_part3_switch4" id="production_part3_switch4" 
                             <?php if(!empty($ques_20)){ if($ques_20['answer']=='1'){ echo 'checked="checked"'; } } ?> value="20">
                        </div>
                   </div>
                </div>
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            <input type='checkbox' name="production_part3_switch5" id="production_part3_switch5" 
                             <?php if(!empty($ques_21)){ if($ques_21['answer']=='1'){ echo 'checked="checked"'; } } ?> value="21">
                        </div>
                   </div>
                </div>
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            <input type='checkbox' name="production_part3_switch6" id="production_part3_switch6" 
                             <?php if(!empty($ques_22)){ if($ques_22['answer']=='1'){ echo 'checked="checked"'; } } ?> value="22">
                        </div>
                    </div>
                </div>
                ...
                <div class="details_main">
                    ...
                    <div class="col-sm-5">
                        <textarea name="production_part3_notes2" id="production_part3_notes2" cols="30" rows="5" class="form-control" 
                                onkeyup="$('.error_production_part3_notes2').addClass('hide');"> <?php if(!empty($ques_23)){ echo $ques_23['notes']; } ?></textarea> 
            ...
            <div class="col-sm-6 col-sm-offset-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group pull-right">
                          <div class="controls">
                            <input type="hidden" name="production_part3_h1" value="<?php if(!empty($ques_17)){ echo $ques_17['id']; } ?>" id="production_part3_h1">
                            <input type="hidden" name="production_part3_h2" value="<?php if(!empty($ques_18)){ echo $ques_18['id']; } ?>" id="production_part3_h2">
                            <input type="hidden" name="production_part3_h3" value="<?php if(!empty($ques_19)){ echo $ques_19['id']; } ?>" id="production_part3_h3">
                            <input type="hidden" name="production_part3_h4" value="<?php if(!empty($ques_20)){ echo $ques_20['id']; } ?>" id="production_part3_h4">
                            <input type="hidden" name="production_part3_h5" value="<?php if(!empty($ques_21)){ echo $ques_21['id']; } ?>" id="production_part3_h5">
                            <input type="hidden" name="production_part3_h6" value="<?php if(!empty($ques_22)){ echo $ques_22['id']; } ?>" id="production_part3_h6">
                            <input type="hidden" name="production_part3_h7" value="<?php if(!empty($ques_23)){ echo $ques_23['id']; } ?>" id="production_part3_h7">
...
<?php
    $ques_24 = $this->products_model->getfrom('product_question', false, array('where'=>array('product_id'=>$product_id,'question_id'=>'24')),array('single'=>true) ); 
    $ques_25 = $this->products_model->getfrom('product_question', false, array('where'=>array('product_id'=>$product_id,'question_id'=>'25')),array('single'=>true) ); 
?>    
                ...
                <div class="label_main">   
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            ...
                            <?php if(!empty($ques_24)){ if($ques_24['answer']=='1'){ echo 'checked="checked"'; } } ?> value="24">
                        </div>
                    </div>
                </div>
                ...
                <div class="label_main">   
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            ...
                            <?php if(!empty($ques_25)){ if($ques_25['answer']=='1'){ echo 'checked="checked"'; } } ?> value="25">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-sm-offset-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group pull-right">
                          <div class="controls">
                            <input type="hidden" name="production_part4_h1" value="<?php if(!empty($ques_24)){ echo $ques_24['id']; } ?>" id="production_part4_h1">
                            <input type="hidden" name="production_part4_h2" value="<?php if(!empty($ques_25)){ echo $ques_25['id']; } ?>" id="production_part4_h2">
                ...
                <div class="label_main">   
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            ...
                            <?php if(!empty($ques_26)){ if($ques_26['answer']=='1'){ echo 'checked="checked"'; } } ?> value="26">
                        </div>
                    </div>
                </div>
                 ...
                 <div class="details_main">
                    ...
                    <div class="col-sm-5">
                        <textarea cols="30" rows="5" class="form-control" name="production_part5_notes1" 
                                  id="production_part5_notes1" onkeyup="$('.error_production_part5_notes1').addClass('hide');"> <?php if(!empty($ques_26)){ echo $ques_26['notes']; } ?></textarea> 
                    ...
                    <div class="col-sm-3">
                        <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                            <input type='checkbox' name="production_part5_switch2" id="production_part5_switch2" 
                             <?php if(!empty($ques_27)){ if($ques_27['answer']=='1'){ echo 'checked="checked"'; } } ?> value="27">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-sm-offset-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group pull-right">
                          <div class="controls">
                            <input type="hidden" name="production_part5_h1" id="production_part5_h1" value="<?php if(!empty($ques_26)){ echo $ques_26['id']; } ?>">
                            <input type="hidden" name="production_part5_h2" id="production_part5_h2" value="<?php if(!empty($ques_27)){ echo $ques_27['id']; } ?>" >
