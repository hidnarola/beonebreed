                                    ...
                                    <ul id="notes" class="tab-ul">
                                        ...
                                        ?> 
                                            <li style="list-style-type:none;">
                                                <input type="checkbox" value="<?php echo $a_note['id']; ?>" class="chk_notes" id="chk_attachment" name="chk[]">
                                                <a href="javascript::void(0)" id="<?php echo $a_note['id']; ?>" class="notes_link" data-desc="<?php echo $a_note['description']; ?>"> 
                                                    vxvx
                                                </a>
                                                <span style="margin-left:60px"><?php echo $a_note['created_date']; ?></span>
                                            </li>
                                        <?php } } ?>
                                    </ul>
                                </div>
