 ...
 <?php
    ...
    if(!empty($data_admin_part_2)){
        foreach($data_admin_part_2 as $dap){
            if($dap['dimension_id'] == '1'){ $retail_data =$dap; }
            if($dap['dimension_id'] == '2'){ $mastercase_data =$dap; }
            if($dap['dimension_id'] == '3'){ $innercase_data=$dap; }
            if($dap['dimension_id'] == '4'){ $pallet_data= $dap; }
        }
    }
    ...
    if(!empty($data_admin_part_3)){
        foreach($data_admin_part_3 as $ques){
            if($ques['question_id']=='11'){ $ques_11 = $ques; }    
            if($ques['question_id']=='12'){ $ques_12 = $ques; }    
...
<div class="complete-level">
    ...
    <div class="inline-block complete-level-ul"> 
        <ul>
            ...
            <li class="part_2_admin <?php if($admin_complete_part['part_2'] != '0'){ echo 'active'; }?>">
                <span></span>
                <span>PART 2</span>
            </li>
            <li class="part_3_admin <?php if($admin_complete_part['part_3'] != '0'){ echo 'active'; }?>">
                <span></span>
                <span>PART 3</span>
            </li>
        </ul>
                            ...
                            <div class='controls'>
                                <label class='control-label check-box-margin'>
                                    ...
                                    <input type="checkbox" name="complete_admin_part_2" 
                                           id="complete_admin_part_2" <?php if($admin_part2_checkbox =='1'){ echo 'checked disabled';} ?> > 
                        ...
                        <div class="col-sm-4">
                            <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                              <input type='checkbox' name="switch_11" id="11" value="11" 
                                <?php if(isset($ques_11['answer'])){ if($ques_11['answer'] == '1'){ echo 'checked'; } }?> >
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <input type="checkbox" name="complete_admin_part_3"  
                                <?php if($admin_part3_checkbox =='1'){ echo 'checked="checked" disabled="disabled"'; } ?>id="complete_admin_part_3" > Part-3 Completed (34%)
                            <br/>
