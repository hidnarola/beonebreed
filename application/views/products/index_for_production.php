                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                            <?php
                                $production_bar = $prod->production_complete;
                                
                                if(!empty($production_bar)){
                                    $exp_sum = json_decode($production_bar,true);
                                    $sum = array_sum(array($exp_sum['part_1'],$exp_sum['part_2'],$exp_sum['part_3'],$exp_sum['part_4'],$exp_sum['part_5']));
                                }else{
                                    $sum = 0;
                                }
