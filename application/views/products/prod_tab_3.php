    ...
    <div class="row">
        <div class="form-horizontal label-left">
            ...
            <div class="label_main">   
                ...
                <div class="col-sm-3">
                    <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                        <input type='checkbox' name="production_part4_switch1" id="production_part4_switch1" value="28">
                    </div>
                </div>
            </div>
            ...
            <div class="label_main">   
                ...
                <div class="col-sm-3">
                    <div class='make-switch switch' data-off-label='&lt;i class="icon-remove"&gt;&lt;/i&gt;' data-on-label='&lt;i class="icon-ok"&gt;&lt;/i&gt;'>
                        <input type='checkbox' name="production_part4_switch2" id="production_part4_switch2" value="29">
                    </div>
                </div>
            </div>
        </div>
...
//                        $('#chkbox_production_part3').attr('checked', true); 
...
//                        $('#chkbox_production_part4').prop('checked', true); // Disable Checkbox
                        $('.percentage_complete_production').html(data.complete_bar_no + '%'); // Update Percentage for product update
                        if(data.completed == 'true')
                        {    
...
//                        $('#chkbox_production_part5').prop('checked', true); 
                        $('.percentage_complete_production').html(data.complete_bar_no + '%'); // Update Percentage for product update
                        if(data.completed == 'true')
                        {
