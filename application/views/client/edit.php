                ...
                <div class='box-content'>
                    <form class="form" style="margin-bottom: 0;" method="post" action="" accept-charset="UTF-8" enctype="multipart/form-data">
                        <div class='form-group'>
                            ...
                            <input class='form-control' id='inputText' placeholder='Action' type='text' name='username' value="<?php if (!empty($client['username'])) {
    echo $client['username'];
                            ...
                            <span style="color:red"><?php echo form_error('username'); ?><span>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <input class='form-control' id='inputText' placeholder='Resposible' type='text' name='email' value="<?php if (!empty($client['email'])) {
    echo $client['email'];
} ?>">
                                        <span style="color:red"><?php echo form_error('email'); ?><span>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <input class='form-control'  type='hidden' name='hdn_logo_name' value="<?php if (!empty($client['logo_name'])) {
    echo $client['logo_name'];
} ?>">
                                                </div>
