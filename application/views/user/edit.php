                ...
                <form class="form" style="margin-bottom: 0;" method="post" action="" accept-charset="UTF-8">   
                  <div style="display:inline-block;float:left;width:45%" class='box-content'>
                    <div class='form-group'>
                     ...
                     <div class='form-group'>
                        ...
                        <input class='form-control' id='inputText' placeholder='Username' type='text' name='username' value="<?php if(!empty($user['username'])) {echo $user['username'];} ?>">
                  ...
                  <div style="display:inline-block;float:right;width:50%" class='box-content'>
                    ...
                    <div class='form-group'>
                        ...
                        <input class='form-control' id='inputText' placeholder='Email' type='text' name='email' value="<?php if(!empty($user['email'])) {echo $user['email'];} ?>">
