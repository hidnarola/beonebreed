            ...
            <div class='col-sm-12'>
                <div class='box bordered-box orange-border'>
                    <div class='box-header orange-background'>
                        <div class="title"><?= lang('idea_heading') ?></div>
                    </div>
                                    ...
                                    <div style="display:inline-block;float:left;width:45%" class='box-content'>
                                        <div class='form-group'>
                                            ...
                                            <span style="color:red"><?php echo form_error('name'); ?><span>
                                                    ...
                                                    <div class='form-group'>
                                                        ...
                                                        <select class="form-control js-example-data-array-selected1 store" name="suggestion_type" >
                                                            <option value="">Select Type</option>
                                                            <?php
                                                            if (!empty($suggestion_type)) {
                                                                foreach ($suggestion_type as $k => $v) {
                                                                    if ($v->id == $suggestion['suggestion_type']) {
                                                                        ?>
                                                                ...
                                                                <div class='form-group'>
                                                                    ...
                                                                    <span style="color:red"><?php echo form_error('product'); ?><span>
                                                                            ...
                                                                            <div class='form-group'>
                                                                                ...
                                                                                <input class='form-control' id='inputText' placeholder='Subject' type='text' name='subject' value="<?php
                                                                                if (!empty($suggestion['subject'])) {
                                                                                    echo $suggestion['subject'];
                                                                                }
                                                                                ?>">
                                                                                    ...
                                                                                    <span style="color:red"><?php echo form_error('store'); ?><span>
                                                                                            ...
                                                                                            <div class='form-group'>
                                                                                                ...
                                                                                                <textarea class="form-control" rows="5" id="contact_info" name="contact_info"><?php
                                                                                                    if (!empty($suggestion['contact_info'])) {
                                                                                                        echo $suggestion['contact_info'];
                                                                                                    }
                                                                                                    ?></textarea>
                                                                                            ...
                                                                                            <div class='text-right form-actions form-actions-padding-sm form-actions-padding-md form-actions-padding-lg' style='margin-bottom: 0;'>
                                                                                                ...
                                                                                                <a class='btn' type='submit' href="<?php echo site_url('client_suggestion/'); ?>"><?= lang('Back') ?></a>
                                                                                            </div>
                                                                                            </div>
                                                                                                                                                            ...
                                                                                                                                                            <div class="col-md-6">
                                                                                                                                                                <ul id="notes" class="tab-ul">
                                                                                                                                                                    <?php foreach ($notes as $u_key) { ?>
                                                                                                                                                                        ...
                                                                                                                                                                        <li style="list-style:none"><input type="checkbox" name="chk[]" id="chk_attachment" class="chk_notes" value="<?php echo $u_key->id; ?>"><a href="javascript:void(0)"  data-desc="<?php echo $u_key->description; ?>" class="notes_link" id="<?php echo $u_key->id; ?>"><?php echo $u_key->name; ?></a><span style="margin-left: 60px;"><?php
                                                                                                                                                            ...
                                                                                                                                                            <div class="col-md-6">
                                                                                                                                                                ...
                                                                                                                                                                <ul id="external_links" class="tab-ul">
                                                                                                                                                                    ...
                                                                                                                                                                    <?php foreach ($external_link as $u_key) { ?>
                                                                                                                                                                        ...
                                                                                                                                                                        <li style="list-style:none"><input type="checkbox" name="chk[]" id="chk_external_link" class="chk_external_link" value="<?php echo $u_key->id; ?>"><a href="javascript::void(0)" class="external_link_data " data-desc="<?php echo $u_key->description; ?>" ><?php echo $u_key->name; ?></a><span style="margin-left: 60px;"><?php
                                                                                                                                                                                $date = new DateTime($u_key->created_date);
                                                                                                                                                                                echo $date->format('d F Y');
                                                                                                                                                                                ?></span></li>
                                        ...
                                        $('#delete_my_notes').click(function() {
                                            ...
                                            if (cek_id.length == 0) {
                                                ...
                                                if (confirm("Are you sure you want to delete this?")) {
                                                    $.ajax({
                                                        url: '<?php echo base_url() . "suggestion/delete_selected_notes"; ?>',
                                                        type: 'post',
                                                        data: {ids: cek_id},
                                                        dataType: 'json',
                                        ...
                                        $('#delete_my_upload').click(function() {
                                            ...
                                            if (cek_id.length == 0) {
                                                ...
                                                if (confirm("Are you sure you want to delete this?")) {
                                                    $.ajax({
                                                        url: '<?php echo base_url() . "suggestion/delete_selected_attachemnt"; ?>',
                                                        type: 'post',
                                                        data: {ids: cek_id},
                                                        dataType: 'json',
                                                        success: function(data) {
                                        ...
                                        $('#delete_my_external_link').click(function() {
                                            ...
                                            if (cek_id.length == 0) {
                                                ...
                                                if (confirm("Are you sure you want to delete this?")) {
                                                    $.ajax({
                                                        url: '<?php echo base_url() . "suggestion/delete_selected_link"; ?>',
                                                        type: 'post',
                                                        data: {ids: cek_id},
                                                        dataType: 'json',
                                                        success: function(data) {
