	  ...
	  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
		<div class='box-header orange-background'>
		  <div class='title'>Report</div>
                        <a href="<?php echo site_url('quality/add') ?>" class="btn btn-primary pull-right">New</a>
		  </div>
		...
		<div class='box-content box-no-padding'>
		  <div class='responsive-table'>
            ...
            ?> 
					...
					<td>
					   <div class='text-left'>
						<a class='btn btn-primary btn-xs' href='<?php echo site_url('quality/edit/'.$u_key->id) ?>'>
						  <i class='icon-list'></i>
						  View
						</a>
