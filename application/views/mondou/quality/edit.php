                ...
                <form class="form" style="margin-bottom: 0;" method="post" action="" accept-charset="UTF-8" enctype="multipart/form-data">   
                  <div style="display:inline-block;float:left;width:45%" class='box-content'>
                    <div class='form-group'>
                        ...
                        <input class='form-control' id='inputText' placeholder='Name' type='text' name='name' value="<?php if(!empty($quality['name'])) {echo $quality['name'];} ?>">
                    ...
                    <div class='form-group'>
                        ...
                        <input class='form-control' id='inputText' placeholder='Title' type='text' name='title' value="<?php if(!empty($quality['title'])) {echo $quality['title'];} ?>">
                        
                    </div>
                     <div class='form-group'>
                        <label for='inputText'>Description</label>
                        <textarea class="form-control" rows="5" id="comment" name="description"><?php if(!empty($quality['description'])) {echo $quality['description'];} ?></textarea>
                  ...
                  <div style="display:inline-block;float:right;width:50%" class='box-content'>
                     ...
                     <div class='form-group'>
                        ...
                        <textarea class="form-control" rows="5" id="contact_info" name="contact_info"><?php if(!empty($quality['contact_info'])) {echo $quality['contact_info'];} ?></textarea>
                       
                    </div>
                     <div class='form-group'>
                        <label for='inputText'>#Ds</label>
                        <input class='form-control' id='inputText' placeholder='#Ds' type='text' name='ds' value="<?php if(!empty($quality['ds'])) {echo $quality['ds'];} ?>">
                       <!-- <span style="color:red"><?php //echo form_error('name'); ?><span>-->
                    </div>
                     <div class='form-group'>
                        <label for='inputText'>Qty In Store</label><span style="color:red">*</span>
                        <input class='form-control store' id='inputText' placeholder='Qty In Store' type='text' name='qty_in_store' value="<?php if(!empty($quality['qty_in_store'])) {echo $quality['qty_in_store'];} ?>" >
                        <span style="color:red"><?php echo form_error('qty_in_store'); ?><span>
                    </div>
                     <div class='form-group'>
                        <label for='inputText'>Qty Defect</label><span style="color:red">*</span>
                        <input class='form-control' id='inputText' placeholder='Qty Defect' type='text' name='qty_defect' value="<?php if(!empty($quality['qty_defect'])) {echo $quality['qty_defect'];} ?>">
                        <span style="color:red"><?php echo form_error('qty_in_store'); ?><span>
                    </div>
